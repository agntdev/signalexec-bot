...
const HELP =
  "Use /start to configure your channel and trade percentage.\n\n" +
  "Add this bot as a channel admin so it can receive signal posts. Valid signals need an asset and CALL or PUT direction.";
